...
A repository for sharing the top-20 popular JavaScitp projects collected from GitHub and labeled by [MA-SZZ](https://github.com/danielcalencar/ma-szz) algorithm.


# Struct
1. **DATA**

    This directory contains the labeled datas in the form of csv.

2. **CODE**

    This directory contains the code for replication and the manually checked samples.
...
||SO|Number of specical operator in JavaScript programming language by the current change|
